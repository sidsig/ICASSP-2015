...
\name{Siddharth Sigtia$^\ast$,Emmanouil Benetos$^\ast$,Tillman Weyde$^\ast$,Artur Garcez D'Silva$^\ast$,Nicolas Boulanger-Lewandownski$^\ast$,Simon Dixon$^\ast$}
...
$\ddag$ Department of Computer Science, City University London, London, UK\\
$\dag$ Google Inc, Mountain View, California, USA}
%
% Single address.
% ---------------
