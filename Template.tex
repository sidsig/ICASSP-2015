...
\nametwo{Siddharth Sigtia$^\ast$\thanks{SS was funded the by Pump-Priming fund awarded by City University, EB is supported by a City University London Research Followship.},Emmanouil Benetos$^\dag$,Tillman Weyde$^\dag$}{Artur S. d'Avila Garcez$^\dag$,Nicolas Boulanger-Lewandowski$^\ddag$ and Simon Dixon$^\ast$}
...
We evaluate the performance of our system using the evaluation metrics used in MIREX \cite{bay2009evaluation}. We present F-measures for both frame-based and note tracking evaluation metrics. Additionally, we report precision, recall and accuracy measures for the 3 best performing models.
